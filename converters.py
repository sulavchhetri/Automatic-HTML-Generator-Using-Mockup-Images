    ...
    def get_html_body(self):
        ...
        for component in final:
            if component[6] == "Image":
                ...
                body += f'<span class="image"style="font-size:10rem;position: absolute;left:{round(float(component[0]))}px;top:{round(float(component[1]))}px;width:{round(float(component[2]))}px;height:{round(float(component[3]))}px;background-color:black">\n'
                body+='</span>'
            ...
            if component[6] == "Button":
                ...
                body += '<button class="favorite styled" type="button">Click Me!</button>\n'
                body+='</div>\n'
